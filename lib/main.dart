...
class _CurrencyExchangeState extends State<CurrencyExchange> {
  ...
  Widget build(BuildContext context) {
    ...
    void getExchangeRateData(value) async {
      NetworkHelper baseRateHelper = NetworkHelper('https://api.exchangeratesapi.io/latest?base=$value');
      ...
      child: Scaffold(
        body: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              Expanded(child: Center(child: Text('1 $dropdownValue1 equals to ' + converter.toStringAsFixed(2) + ' $dropdownValue2 ',style: TextStyle(fontSize: 60),))),
              Expanded(
                child: Row(
